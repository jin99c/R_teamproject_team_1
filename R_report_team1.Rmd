...
##1. 초록
 ...
 네 번째, 부부생활에서의 성 생활 가치 중요도의 경우, 성폭력 민감도와 비례관계를 나타냈다.
...
```
 ...
 성폭력 민감도에 따른 경제적 결정권 주체 인식에 관해서 전반적인 전개 양상은 남자가 경제적 결정권을 가지는 것에 ‘별로 그렇지 않다’로 답한 사람들이 가장 많고, ‘조금 그렇다’, ‘매우 그렇다’가 그 뒤를 따르며, ‘전혀 그렇지 않다’가 가장 낮은 것으로 나타났다. 질문 자체가 남녀가 경제적 결정권을 분배하는 것을 묻는 것이 아니라, 남자가 결정권을 가져야 하는지를 묻고 있으므로, ‘전혀 그렇지 않다’에 답한 사람과 ‘별로 그렇지 않다’에 답한 사람들이 경제적 결정권을 어떻게 나누어야 하는지는 알 수 없다. 그러나, ‘매우 그렇다’와 '조금 그렇다', 남자가 경제적 결정권의 주체가 되어야 한다고 생각하는 것이므로, 그 항목을 통해 비교하도록 한다.
 성폭력 민감도가 높은 사람들은 경제적 결정권을 남자가 가져야한다고 생각하는 비중(1, 2번 응답을 더한 결과)이 약 2.2%이고, 성폭력민감도가 낮은 사람들의 경우, 약 15.2%로 나타났다. 이를 통해, 성폭력 민감도가 낮은 사람들이 경제적 결정권의 주체가 남자가 되어야 생각하는 것을 알 수 있었다. 
